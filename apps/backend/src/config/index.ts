...
function loadConfig(): EnvConfig {
  ...
  const envWithDefaults = {
    ...env,
    JWT_SECRET: env.JWT_SECRET ?? (isProduction ? undefined : 'development-secret-key-min-32-characters-long'),
    JWT_REFRESH_SECRET: env.JWT_REFRESH_SECRET ?? (isProduction ? undefined : 'development-refresh-secret-key-min-32-chars'),
  };
